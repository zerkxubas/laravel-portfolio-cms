...
interface AdminInterface
{
     ...
     * Get stats
     *
     * @param string|null $todayStartDate
     * @param string|null $todayEndDate
     * @param string|null $thisWeekStartDate
     * @param string|null $thisWeekEndDate
     * @param string|null $thisMonthStartDate
     * @param string|null $thisMonthEndDate
